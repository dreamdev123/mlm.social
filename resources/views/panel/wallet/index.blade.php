@extends('layouts.app', ['ACTIVE_TITLE' => 'WALLET'])
    ...
    <div class="row m-0 p-0 w-100 wallet-section">
        <div class="row justify-content-center m-0 w-100">
            <div class="col-md-6 p-0">
                ...
                <div class="odd-color-section px-4 m-0 pt-4 pb-2">
                ...
                <div class="odd-color-section px-4 m-0 pt-4 pb-2 mb-4">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex">
                    ...
                    <p class="text-gray wallet-address">myname@myemail.com</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center align-items-center my-2 btn-section w-100 p-0 m-0">
