        ...
        <div class="row justify-content-center m-0 w-100">
            <div class="col-md-6 p-0">
                ...
                <div class="search-input-section">
                    <input id="trackerSearchKey" type="text" class="form-control" name="searchKey" placeholder="Search Name or click Sales Level">
                ...
                <div class="row w-100 p-0 m-0">
                    ...
                    <div class="col-4 col-sm-4 rowItem">
                        <div class="rowItem-wrp active">
                            <div class="item">
                                <img class="item-icon mb-2 mb-md-3" src="{{ asset('images/svg/Sales.svg') }}">
