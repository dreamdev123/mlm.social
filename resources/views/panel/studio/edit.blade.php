@extends('layouts.app', ['ACTIVE_TITLE' => 'STUDIO'])
...
<div class="main-bg">
    ...
    <video autoplay muted loop class="wave-video-section-mobile studio-video" playsinline>
        <source type="video/mp4">
    </video>
    <div class="menu">
            ...
            <div class="contentItem">
                <div class="contentItem-wrp">
                    <div class="thumbnail-card portfolio-image color-change-black {{ $user->profile->darken_mode_1 == 1 ? 'active' : '' }}" onclick="imgColorToBlack()">
                        <img src="{{ asset('images/svg/ImageIconBlack.svg') }}">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex menuSubItem">
                ...
                <div class="child">
                    ...
                    <div class="contentItem">
                        <div class="contentItem-wrp">
                            <div class="text-card portfolio-image">
                                <img src="{{ asset('images/svg/DotBlack.svg') }}" onclick="changeFontColorBlack()">
                            </div>
                        </div>
                    </div>
                </div>
