  ...
  <div class="row m-0 p-0 w-100 posts-section">
    <div class="row justify-content-center m-0 py-3 w-100">
      <div class="col-md-6 p-0">
        <div class="text-center pb-3 create-title">CREATE A BRAND PROMOTION</div>
        ...
        <div class="post-top-content">
          <div class="title trade-title editable" contenteditable="true">Type Subject</div>
          <div class="content trade-address editable" contenteditable="true">City, Country</div>
        </div>
