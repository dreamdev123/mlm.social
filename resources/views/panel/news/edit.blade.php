            ...
            <div class="member-link">
              <div class="member-avatar-wrp">
                <div class="member-avatar">
                  <img class="social-logo" src="{{ asset('images/Logos/Logo1.svg') }}" alt="Logo">
                </div>
              </div>
              <div class="member-name">Brandfields Support Team</div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center m-0 p-0 w-100 gap">
          ...
          <div class="col-4 col-sm-4 col-md-4 contentItem both-border-trans">
              <div class="contentItem-wrp">
                  ...
                  <img src="{{ asset('uploads/posts/'.$post->small_featured_image_url2.'?'.time()) }}" class="post-image2 {{ $post->small_featured_image_url2 ? '' : 'd-none' }} blur-img" />
              </div>
          </div>
          <div class="col-4 col-sm-4 col-md-4 contentItem left-border-trans">
              <div class="contentItem-wrp">
                  ...
                  <img src="{{ asset('uploads/posts/'.$post->small_featured_image_url3.'?'.time()) }}" class="post-image3 {{ $post->small_featured_image_url3 ? '' : 'd-none' }} blur-img" />
              </div>
          </div>
        </div>
